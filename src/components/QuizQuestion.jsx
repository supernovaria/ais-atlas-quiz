...
import { prewarm, playSuccess, playMistake } from '../sounds.js';
...
export default function QuizQuestion({ question, questionNumber, totalQuestions, onAnswer, showResult, submitRef, soundVariant }) {
  ...
  function handleSubmit() {
    ...
    if (isCorrect) playSuccess(soundVariant); else playMistake(soundVariant);
    onAnswer(isCorrect);
  }
